...
module.exports = class Film {
  ...
  static async insert({
    ...
    const { rows } = await pool.query(
      `
      INSERT INTO films (director_id, film_name, film_image, film_description, film_budget, film_url, film_genre) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *`,
      [filmDirectorId, filmName, filmImg, filmDescription, filmBudget, filmUrl, JSON.stringify(filmGenre)]
    );
