...
module.exports = class Film {
  ...
  static async insert({
    ...
    console.log(filmImg, 'FILM IMG')
    console.log(filmDescription, 'FILM DESC')
    console.log(filmBudget, 'FILM BUDG')
    console.log(filmUrl, 'FILM URL')
    console.log(filmGenre, 'FILM GENRE')

    const { rows } = await pool.query(
      `
      INSERT INTO films (film_name, film_image, film_description, film_budget, film_url, film_genre) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`,
      [filmName, filmImg, filmDescription, filmBudget, filmUrl, JSON.stringify(filmGenre)]
    );
